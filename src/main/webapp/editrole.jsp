            ...
            <article>
                ...
                <div class="text-article">
                    <form method="POST" action="">
                        <input type="hidden" name="id" value="${rolesEdit[0].id}" />
                        <div class="mb-3 row">
                            <label class="col-sm-3 col-form-label">Код</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" readonly value="${rolesEdit[0].id}" />
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="col-sm-3 col-form-label">Должность</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="namerole" value="${rolesEdit[0].nameRole}" />
                            </div>
                        </div>
